...
interface SOPProps {
    sops: types.SOP[];
    sopCrud: CrudProps<types.SOP>;
    profile: types.Profile;
    showNotification: (message: string) => void;
}

const SOPManagement: React.FC<SOPProps> = ({ sops, sopCrud, profile, showNotification }) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (modalMode === 'add') {
            ...
            await sopCrud.update(selectedSop.id, updatedSopData);
