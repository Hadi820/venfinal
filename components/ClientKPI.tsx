...
interface ClientReportsProps {
    ...
    clientFeedbackCrud: CrudProps<ClientFeedback>;
    showNotification: (message: string) => void;
}

const ClientReports: React.FC<ClientReportsProps> = ({ clients, leads, projects, feedback, clientFeedbackCrud, showNotification }) => {
