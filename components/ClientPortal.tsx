                                            ...
                                            <div className="ml-4">
                                                ...
                                                {isActive && !isConfirmed && (
                                                    <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                                                        ...
                                                        <button onClick={() => { if(selectedProject) onConfirm(selectedProject.id, subStatus.name, '')}} className="mt-2 text-sm font-semibold text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded-lg inline-flex items-center gap-2"><SendIcon className="w-4 h-4" /> Konfirmasi</button>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
